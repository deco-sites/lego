...
const variants = {
  ...
  icon:
    "h-[36px] px-2 rounded-full bg-card-cta-dark text-default border-transparent hover:bg-card-cta-light active:border-interactive disabled:text-subdued disabled:bg-interactive-inverse focus:outline-none",
};
