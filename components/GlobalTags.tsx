      ...
      <style
        dangerouslySetInnerHTML={{
          ...
          @font-face {
            ...
            font-display: swap;
            src: url(${
            asset("/fonts/SansaSoftPro-Light.ttf")
          }) format('woff2');
          ...
          @font-face {
            ...
            font-display: swap;
            src: url(${
            asset("/fonts/SansaSoftPro-Normal.ttf")
          }) format('woff2');
            unicode-range: U+0100-024F, U+0259, U+1E00-1EFF, U+2020, U+20A0-20AB, U+20AD-20CF, U+2113, U+2C60-2C7F, U+A720-A7FF;
          }
          /* latin */
          ...
          @font-face {
            ...
            font-display: swap;
            src: url(${
            asset("/fonts/SansaSoftPro-SemiBold.ttf")
          }) format('woff2');
            unicode-range: U+0100-024F, U+0259, U+1E00-1EFF, U+2020, U+20A0-20AB, U+20AD-20CF, U+2113, U+2C60-2C7F, U+A720-A7FF;
          }
          /* latin */
          ...
          @font-face {
            ...
            font-display: swap;
            src: url(${
            asset("/fonts/SansaSoftPro-Bold.ttf")
          }) format('woff2');
            unicode-range: U+0100-024F, U+0259, U+1E00-1EFF, U+2020, U+20A0-20AB, U+20AD-20CF, U+2113, U+2C60-2C7F, U+A720-A7FF;
          }
          /* latin */
          ...
          @font-face {
            ...
            font-display: swap;
            src: url(${
            asset("/fonts/SansaSoftPro-Black.ttf")
          }) format('woff2');
            unicode-range: U+0100-024F, U+0259, U+1E00-1EFF, U+2020, U+20A0-20AB, U+20AD-20CF, U+2113, U+2C60-2C7F, U+A720-A7FF;
          }
          /* latin */
